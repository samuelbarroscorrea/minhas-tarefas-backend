...
public interface TaskRepository extends JpaRepository<Tarefa, Integer>, JpaSpecificationExecutor<Tarefa> {
	...
	public List<Tarefa> findByCategoria(TaskCategory categoria);
